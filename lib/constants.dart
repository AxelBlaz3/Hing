...
const String kAPIGetFollowingRoute =
    kBaseUrl + kAPIPrefix + '/user/{}/following';
const String kAPIGetFollowersRoute =
    kBaseUrl + kAPIPrefix + '/user/{}/followers';
const String kAPIGetNotificationsRoute =
    kBaseUrl + kAPIPrefix + '/user/{}/notifications';
const String kAPIGetFavoritesRoute =
    kBaseUrl + kAPIPrefix + '/user/{}/favorites';
...
const String kAPIGetRecipeLikesRoute =
    kBaseUrl + kAPIPrefix + '/recipe/{}/likes';
const String kAPISearchRecipesRoute =
    kBaseUrl + kAPIPrefix + '/recipe/search/{}';
